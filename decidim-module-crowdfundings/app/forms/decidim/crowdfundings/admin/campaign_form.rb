...
module Decidim
  module Crowdfundings
    module Admin
      # This class holds a Form to create/update campaigns from
      ...
      class CampaignForm < Decidim::Form
        ...
        def map_model(campaign)
          self.amounts = campaign.amounts&.join(", ")
        end
        ...
        def amounts_consistency
          ...
          errors.add(
            ...
            I18n.t(
              ...
              scope: "activemodel.errors.models.campaign.attributes"
            )
          )
        end
