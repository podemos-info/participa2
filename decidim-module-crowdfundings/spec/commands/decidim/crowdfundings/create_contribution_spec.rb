    ...
    describe CreateContribution do
      ...
      context "when census service is down" do
        ...
        it "do not creates the contribution" do
          expect { subject.call }.to change { Decidim::Crowdfundings::Contribution.count }.by(0)
        end
      ...
      context "when everything is ok" do
        ...
        let(:contribution) do
          Decidim::Crowdfundings::Contribution.last
        end
        ...
        context "with existing payment method / Direct debit" do
          ...
          it "creates the contribution" do
            expect { subject.call }.to change { Decidim::Crowdfundings::Contribution.count }.by(1)
          end
        ...
        context "with credit card" do
          ...
          before do
            ...
            allow(subject).to receive(:validate_contribution_url)
